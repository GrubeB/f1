...
import pl.app.report.CellStyleType;
import pl.app.report.Report;
import pl.app.report.ReportGenerator;
...
public class ThreadReportGenerator implements GenerateThreadReport {
    ...
    private void writeHeader(Report report) {
        ...
        CellStyle headerStyle = report.generateCellStyle(CellStyleType.ARIAL, CellStyleType.BOLD, CellStyleType.FONT14, CellStyleType.BACKGROUND_PRIMARY_DARK);
